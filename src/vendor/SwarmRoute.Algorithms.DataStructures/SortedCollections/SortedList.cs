...
using AJR.Platform.Algorithms.DataStructures.Common;
using AJR.Platform.Algorithms.DataStructures.Trees;

namespace AJR.Platform.Algorithms.DataStructures.SortedCollections
{
    /// <summary>
